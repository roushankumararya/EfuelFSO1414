...
/**
 * Created by Jinesh Francis on 09-11-2016.
 */
...
public class AwesomeToggle extends View {
    ...
    private String textOn = "";//"Yes";
    private String textOff = "";//"No";
    ...
    private void initColors(Context context, AttributeSet attrs) {
        textOn = "";//context.getString(R.string.yes);
        textOff = "";
    ...
    private void init(Context context) {
        ...
        if (readLocale(context).equals("pa")) {
            font = Typeface.createFromAsset(context.getAssets(), "fonts/DroidSansFallbackanmol256.ttf");
        } else {
    ...
    public String readLocale(Context context) {
        SharedPreferences sp = context.getSharedPreferences("Locale", MODE_PRIVATE);
