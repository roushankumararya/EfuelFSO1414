...
public class ViewCashTransactionResponseModel implements Serializable{
    String fuelStation, vehicleNumber, mobileNumber, fuelType, quantity, amount, createdBy, createdById, createdAt, updatedAt, id;
    String pagination;
