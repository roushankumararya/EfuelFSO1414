...
public class TransactionDetailsActivity implements Unbinder {
  private TutorialAcitvity target;

  private View view2131361903;

  @UiThread
  public TransactionDetailsActivity(TutorialAcitvity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TransactionDetailsActivity(final TutorialAcitvity target, View source) {
    this.target = target;

    View view;
    target.tvHeading = Utils.findRequiredViewAsType(source, R.id.tvHeading, "field 'tvHeading'",
