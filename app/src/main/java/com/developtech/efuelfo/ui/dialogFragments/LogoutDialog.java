...
import com.developtech.efuelfo.UserMobileNumber;
...
public class LogoutDialog extends DialogFragment {
    public DIALOG_TYPE dialog_type = DIALOG_TYPE.TOKEN_EXPIRE;
  // public DIALOG_TYPE dialog_type = DIALOG_TYPE.TOKEN_EXPIRE;
   ...
   // UserPreference useshr;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnYes: {
                if (dialog_type==DIALOG_TYPE.LOGOUT)
                {
                    ...
                    appComponent.getSpUtils().saveFuelStation(null);
                        SharedPreferences pref = getActivity().getSharedPreferences("Efule",Context.MODE_PRIVATE);
                        SharedPreferences.Editor editor = pref.edit();
                        editor.clear();
                        editor.commit();
                       Log.e("dfdjfdf"," "+ pref.getString("userId",""));
                        newIntentClear(UserMobileNumber.class, null, true);
