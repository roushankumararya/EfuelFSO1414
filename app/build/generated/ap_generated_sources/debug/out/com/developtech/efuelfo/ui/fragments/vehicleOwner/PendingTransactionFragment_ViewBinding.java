...
public class PendingTransactionFragment_ViewBinding implements Unbinder {
  private PendingTransactionFragment target;

  @UiThread
  public PendingTransactionFragment_ViewBinding(PendingTransactionFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PendingTransactionFragment target = this.target;
