...
public class TotalSaleOperatorsFragment_ViewBinding implements Unbinder {
  private TotalSaleOperatorsFragment target;

  @UiThread
  public TotalSaleOperatorsFragment_ViewBinding(TotalSaleOperatorsFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TotalSaleOperatorsFragment target = this.target;
