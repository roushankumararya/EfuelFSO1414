...
public class DriverVehicleFragment_ViewBinding implements Unbinder {
  private DriverVehicleFragment target;

  @UiThread
  public DriverVehicleFragment_ViewBinding(DriverVehicleFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    DriverVehicleFragment target = this.target;
